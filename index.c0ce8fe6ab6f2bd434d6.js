...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addItemInLocalStorage: () => (/* binding */ addItemInLocalStorage),
/* harmony export */   addTextOnBtn: () => (/* binding */ addTextOnBtn),
/* harmony export */   delTextOnBtn: () => (/* binding */ delTextOnBtn),
/* harmony export */   deleteItemInLocalStorage: () => (/* binding */ deleteItemInLocalStorage)
/* harmony export */ });
...
/* harmony import */ var _helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpersJS/helperIndex */ "./src/helpersJS/helperIndex.js");
   ...
   priceButtons.forEach((el) => {
      ...
      for (let item of d) {
         if (item.currentId === el.parentNode.parentNode.dataset.id) {
            (0,_helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__.addTextOnBtn)(el)
         }
      }
   })
}
...
priceButtons.forEach((el, i) => {
   el.addEventListener('click', (e) => {
      ...
      if (!el.classList.contains('added')) {
         (0,_helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__.addItemInLocalStorage)(card)
         ;(0,_helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__.addTextOnBtn)(el)
      } else {
         (0,_helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__.deleteItemInLocalStorage)(currentId)
         ;(0,_helpersJS_helperIndex__WEBPACK_IMPORTED_MODULE_1__.delTextOnBtn)(el)
      }
   })
})
})();
...
/******/ })()
;
//# sourceMappingURL=index.c0ce8fe6ab6f2bd434d6.js.map